...
) : BaseUseCase<String, NetworkResult<List<Article>>>() {
    override suspend operator fun invoke(params: String): NetworkResult<List<Article>> =
        repository.getNewsByCategory(params, "")
}
